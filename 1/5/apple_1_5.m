...
M = load('Local_reSize_Apple_1_5_A_DE_s.mat')
...
J = load('Local_reSize_Apple_1_5_J_IE_s.mat')
...
L = load('Local_reSize_Apple_1_5_L_DE_s.mat')
...
L2 = load('Local_reSize_Apple_1_5_L_IE_s.mat')

chol(L2.spd_RCovDs)

% chol(L2.log_RCovDs) - not spd
